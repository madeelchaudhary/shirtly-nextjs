...
import IfAuthElse from "../auth/IfAuthElse";
...
export default function Navbar() {
  ...
  const [drapdownState, setDrapdownState] = useState({
    isActive: false,
    idx: null,
  } as { isActive: boolean; idx: null | number });
  ...
  const navigation = [
    ...
    { title: "Shop", path: "/shop", isDrapdown: false },
                ...
                return (
                  <li key={idx}>
                    ...
                    drapdownState.isActive ? (
                      <div className="mt-6 inset-x-0 top-20 w-full bg-white z-20 md:absolute md:border-y md:shadow-md md:mt-0">
                  ...
                  ifAuth={
                    <>
                      ...
                      <li>
                        <button
                          onClick={() => signOut()}
                          className="flex items-center justify-center gap-x-1 w-full py-2 px-4 text-white font-medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex"
                        >
                          Log Out
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
